              ...
              child: Row(
                ...
                children: [
                  FilledButton.icon(
                    ...
                    label:
                        const Text('Scan QR', style: TextStyle(fontSize: 18)),
                    icon: const Icon(Icons.qr_code_scanner),
                  ),
                  ToggleButtons(
                    isSelected: isSelected,
                    onPressed: (int index) async {
                      await OrderServ().OpenClose(context, restaurant.id);
                      setState(() {
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    onPressed: () async {
                                      await OrderServ()
                                          .RemoveItem(context, menu[index].id);
                                      setState(() {});
                                    },
